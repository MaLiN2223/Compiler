...
namespace Compiler
{
	public class PostfixCreator
	{
		...
		public PostfixCreator(ILanguageModel languageModel)
		{
			this.languageModel = languageModel;
		}
		public List<Token> Postfix(IEnumerable<Token> token)
		{
			return InnerPostfix(token).ToList();
		}

		private IEnumerable<Token> InnerPostfix(IEnumerable<Token> tokens)
		{
